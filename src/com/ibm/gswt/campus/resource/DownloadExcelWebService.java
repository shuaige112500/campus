...
@Path("/Download")
public class DownloadExcelWebService {

	private static Logger logger = Logger.getLogger(DownloadExcelWebService.class);
	DownloadService downloadService = new DownloadServiceImpl();

	@GET
	@Produces({MediaType.APPLICATION_JSON})
	public void Download(@QueryParam("eventId") String eventId,
...
//		}
		...
		String path = downloadService.downloadExcel(fileRootPath,eventId);
